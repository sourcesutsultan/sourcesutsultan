...
message = message..' ['..info.username..'](T.ME/d6yyt)  \n'
...
elseif UserID == 1390519416 or UserID == 1872542810 then  
...
if UserID == 1390519416 or UserID == 1872542810 then return sendMsg(msg.chat_id_,msg.id_,"✶⁞  لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
📟┇◢ [قـناة الـسورس](HTTPS://T.ME/d6yyt) ◣
🧑‍💻┇معرف المطور - 
]]..SUDO_USERR)  
return false
else
...
local inline = {{{text="Source Channel : 𝙽𝙸𝚉𝙺",url="T.ME/d6yyt"}}}
send_key(msg.sender_user_id_,'  [Source : 𝙽𝙸𝚉𝙺 ](T.ME/d6yyt)',nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "سلطان" or MsgText[1]=="سلطان" then
local inline = {{{text="🦁 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐔𝐋𝐓𝐀𝐍",url="T.ME/d6yyt"}}}
...
*🦁┇𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐔𝐋𝐓𝐀𝐍
*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*
*📂┇* [Source File](https://t.me/d6tth)

*📬┇* [Source Channel](https://t.me/d6yyt)

*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ *
*📮┇* [Source Dev](https://t.me/xxxeex8)

*👤┇* [Source Admin](https://t.me/tomas_1_9)
]]
end
